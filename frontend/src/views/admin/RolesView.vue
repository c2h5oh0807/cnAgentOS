...
<template>
  ...
  <el-dialog v-model="createVisible" title="新增角色" width="560px" @close="resetCreateForm">
    ...
    <template #footer><el-button @click="createVisible = false">取消</el-button><el-button type="primary" :loading="submitting" @click="createRole">创建角色</el-button></template>
  </el-dialog>
